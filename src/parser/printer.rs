use crate::parser::ast::{
    ...
    CompilationUnit, Expression, FormalParameter, LeftHandSide, MethodBody, MethodDeclaration,
    MethodResult, NormalClassDeclaration, Statement, TopLevelClassOrInterfaceDeclaration, Type,
    ...
    fn fmt_tree(&self, f: &mut Formatter<'_>, prefix: &str, is_last: bool) -> fmt::Result {
        ...
        match self {
            ...
            Expression::Assignment { lhs, rhs, op } => {
                ...
                <LeftHandSide as Into<Expression>>::into(lhs.clone()).fmt_tree(
                    f,
                    &new_prefix,
                    false,
                )?;
